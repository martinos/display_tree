...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm),
   $TreeDisplay = Elm.TreeDisplay.make(_elm);
   ...
   model) {
      return function () {
         ...
         {case "Add":
            return function () {
                 var clearInput = function (model) {
                    return _U.replace([["input"
                                       ,""]],
                    model);
                 };
                 return clearInput(_U.replace([["nodes"
                                               ,A2($Basics._op["++"],
                                               model.nodes,
                                               _L.fromArray([parseInt(model.input)]))]],
                 model));
              }();
   ...
   inputValue) {
      ...
      _L.fromArray([A2($Html.input,
                   _L.fromArray([$Html$Attributes.value(inputValue)
                                ,A2(onInput,address,Update)]),
                   _L.fromArray([]))
                   ,A2($Html.button,
   ...
   var NoOp = {ctor: "NoOp"};
   var app = $Signal.mailbox(NoOp);
   var view = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2(inputView,
                   app.address,
                   model.input)
                   ,$Html.fromElement($TreeDisplay.treeElement(model.nodes))]));
   });
   var initModel = {_: {}
                   ,input: ""
...
Elm.Tree = Elm.Tree || {};
Elm.Tree.make = function (_elm) {
   "use strict";
   _elm.Tree = _elm.Tree || {};
   if (_elm.Tree.values)
   return _elm.Tree.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
...
Elm.TreeDisplay = Elm.TreeDisplay || {};
Elm.TreeDisplay.make = function (_elm) {
   "use strict";
   _elm.TreeDisplay = _elm.TreeDisplay || {};
   if (_elm.TreeDisplay.values)
   return _elm.TreeDisplay.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "TreeDisplay",
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Graphics$Collage = Elm.Graphics.Collage.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Text = Elm.Text.make(_elm),
   $Tree = Elm.Tree.make(_elm);
   var nodeText = F2(function (v,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
